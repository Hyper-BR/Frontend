...
export function useService() {
  function get<T = any>(url: string, params?: Record<string, unknown>, config?: AxiosRequestConfig): AxiosPromise<T> {
    return api.get<T>(url, { params, ...config });
  }

  function post<T = any>(url: string, data?: any, config?: AxiosRequestConfig): AxiosPromise<T> {
  ...
  function patch<T = any>(url: string, data?: any, config?: AxiosRequestConfig): AxiosPromise<T> {
